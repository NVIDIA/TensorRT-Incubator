...
!devMemRef = memref<4xi4, #plan.memory_space<device>>


memref.global @host_buffer : !hostMemRef = dense<3>
memref.global @cuda_buffer : !devMemRef = dense<3>
...
func.func @main() -> i32{
  ...
  scf.for %i = %c0_index to %c4 step %c1_index {
    ...
    executor.print "host_memref[%i] = %s"(%i, %value : index, i4)
  }
...
// CHECK: start!
// CHECK: host_memref[0] = 4
// CHECK: host_memref[1] = 4
// CHECK: host_memref[2] = 4
// CHECK: host_memref[3] = 4
// CHECK: done!
