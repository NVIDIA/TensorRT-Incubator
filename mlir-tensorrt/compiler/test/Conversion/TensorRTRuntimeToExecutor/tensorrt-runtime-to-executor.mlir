...
// CHECK-LABEL:   executor.global @my_func_exec_ctx constant : !executor.ptr<host> {
...
//   CHECK-DAG:     %[[v2:.+]] = executor.get_global @my_func_exec_ctx : !executor.ptr<host>
...
//   CHECK-DAG:     executor.call @_trtrt_enqueue(%[[v2]], %[[v4]], %[[v7]]) : (!executor.ptr<host>, !executor.ptr<host>, !executor.table<!executor.ptr<host>, i64, i64, i64, i64, i64, i64, !executor.ptr<host>, i64, i64, i64, i64, i64, i64>) -> ()
...
// CHECK-DAG: executor.func private @_trtrt_enqueue_alloc(!executor.ptr<host>, !executor.ptr<host>, !executor.ptr<host>, ...)
// CHECK-DAG: executor.func private @_trtrt_create_runtime() -> !executor.ptr<host>
// CHECK-DAG: executor.func private @_trtrt_create_context(!executor.ptr<host>) -> !executor.ptr<host>
// CHECK-DAG: executor.func private @_trtrt_load(!executor.ptr<host>, !executor.ptr<host>, i64) -> !executor.ptr<host>
// CHECK-LABEL: executor.global @tensorrt_runtime : !executor.ptr<host> {
// CHECK: %[[v0:.*]] = executor.call @_trtrt_create_runtime() : () -> !executor.ptr<host>
...
// CHECK-DAG: %[[v3:.*]] = executor.get_global @tensorrt_runtime : !executor.ptr<host>
// CHECK: %[[v4:.*]] = executor.call @_trtrt_load(%[[v3]], %[[v1]], %[[v2]]) : (!executor.ptr<host>, !executor.ptr<host>, i64) -> !executor.ptr<host>
// CHECK: %[[v5:.*]] = executor.call @_trtrt_create_context(%[[v4]]) : (!executor.ptr<host>) -> !executor.ptr<host>
// CHECK: executor.return %[[v5]] : !executor.ptr<host>
// CHECK: }
// CHECK-LABEL: tensorrt.module @trt_funcs {
...
// CHECK: %[[v7:.*]] = executor.get_global @my_func_exec_ctx : !executor.ptr<host>
...
// CHECK: executor.call @_trtrt_enqueue_alloc(%[[v7]], %[[v9]], %[[v10]], %[[v14]]) : (!executor.ptr<host>, !executor.ptr<host>, !executor.ptr<host>, !executor.table<!executor.ptr<device>, i64, i64, i64, i64, i64, i64>) -> ()
