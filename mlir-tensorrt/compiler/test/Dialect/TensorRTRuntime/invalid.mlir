...
func.func @main(%stream: !cuda.stream,
    %arg0: memref<1x3x256x256xf32, strided<[?, ?, ?, ?], offset: ?>>,
    %arg1: memref<1x3x256x256xf32, strided<[?, ?, ?, ?], offset: ?>>,
    %arg3: !trtrt.context) -> memref<1x3x256x256xf32> {
  ...
  trtrt.enqueue %arg3 stream(%stream) (%arg3, %4, %arg0) outs(%alloc) : (memref<1x3x256x256xf32, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x3x256x256xf32>
