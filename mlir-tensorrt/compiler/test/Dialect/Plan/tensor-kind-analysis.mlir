...
func.func @test_inline_group(%arg0: tensor<1xi32>,
  ...
  %1:2 = plan.cluster target(#plan.tensorrt_backend<benefit=1, disallow_shape_tensor_calculations=false>) attributes {tag = "inline_group"} -> tensor<1xi32>, tensor<1xf32> {
...
func.func @test_inline_closed_group(%arg0: tensor<?xf32>, %arg1: tensor<2xi32>, %arg2: index, %arg3: index) -> tensor<?x?xf32> {
  ...
  %1 = plan.dps_cluster  target(#plan.tensorrt_backend<benefit=1,disallow_shape_tensor_calculations=false>)
