...
// CHECK: %[[const:.+]] = tensorrt.constant dense_resource<__elided__> : tensor<50x30xf32>
// CHECK: %[[out:.+]] = tensorrt.matrix_multiply {op0 = #tensorrt.matrix_operation<kNONE>, op1 = #tensorrt.matrix_operation<kTRANSPOSE>} ins(%[[arg0]], %[[const]] : tensor<4x30xf32>, tensor<50x30xf32>) -> tensor<4x50xf32>
// CHECK: return %[[out]]
...
// CHECK: %[[const:.+]] = tensorrt.constant dense_resource<__elided__> : tensor<2x3x6x5xf32>
// CHECK: %[[V0:.+]] = tensorrt.matrix_multiply {op0 = #tensorrt.matrix_operation<kNONE>, op1 = #tensorrt.matrix_operation<kTRANSPOSE>} ins(%[[arg0]], %[[const]] : tensor<2x3x4x5xf32>, tensor<2x3x6x5xf32>) -> tensor<2x3x4x6xf32>
// CHECK: return %[[V0]]
