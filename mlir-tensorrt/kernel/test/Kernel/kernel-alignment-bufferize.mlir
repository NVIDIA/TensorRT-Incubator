...
gpu.module @kernels_multi {
  ...
  func.func @main2(%arg0: tensor<65536xi32> {kernel.attr = 9:i32, kernel.alignment = 16 : i64}, %arg1: tensor<65536xi32> {kernel.attr = 1:i32, kernel.alignment = 64 : i64}) -> tensor<65536xi32> {
    return %arg1 : tensor<65536xi32>
  }
}
