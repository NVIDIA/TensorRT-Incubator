...
func.func @arg_abi_input_byval_memref(
    %arg0: !executor.ptr<host>
      {executor.abi = #executor.arg<byval, memref<?xi32>>,
    ...
    %arg2: !executor.ptr<host> {executor.abi = #executor.arg<byref, memref<?xi32>, undef>},
    %arg3: !executor.ptr<host> {executor.abi = #executor.arg<byref, memref<1xi32>>},
    ...
    %arg5: !executor.ptr<host> {executor.abi = #executor.arg<byref, complex<f32>, undef>})
      attributes {
        executor.func_abi = (memref<?xi32>, i32) -> (memref<?xi32>, memref<1xi32>, i32, complex<f32>)
      } {
  return
}

// CHECK-LABEL: Function<arg_abi_input_byval_memref
// CHECK-SAME:  Signature<args=[MemRef<?xi32, strides=[1], unknown>, i32],
// CHECK-SAME:  results=[MemRef<?xi32, strides=[1], unknown>, MemRef<1xi32, strides=[1], unknown>, i32, complex32],
