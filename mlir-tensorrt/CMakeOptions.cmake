...
# Validate MLIR_TRT_LINK_MTRT_DYLIB and BUILD_SHARED_LIBS
if(MLIR_TRT_LINK_MTRT_DYLIB AND BUILD_SHARED_LIBS)
  message(FATAL_ERROR "MLIR_TRT_LINK_MTRT_DYLIB=ON is not supported with BUILD_SHARED_LIBS=ON")
endif()
