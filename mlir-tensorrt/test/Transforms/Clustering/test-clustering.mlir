// RUN: mlir-tensorrt-opt %s -allow-unregistered-dialect -split-input-file \
...
// RUN: mlir-tensorrt-opt %s -allow-unregistered-dialect -split-input-file -test-clustering | FileCheck %s
// RUN: mlir-tensorrt-opt %s -allow-unregistered-dialect -split-input-file \
