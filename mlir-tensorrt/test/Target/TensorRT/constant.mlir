// RUN: %pick-one-gpu mlir-tensorrt-opt -split-input-file -pass-pipeline="builtin.module(func.func(tensorrt-legalize-int8),translate-tensorrt-to-engine)" -tensorrt-builder-opt-level=0 \
