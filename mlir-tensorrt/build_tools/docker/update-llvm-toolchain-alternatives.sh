...
# Use the 'update-alternatives' command to register the LLVM toolchain.
# This script is used to update the LLVM toolchain alternatives for the
# different LLVM versions.
#
# Usage:
#   update-llvm-toolchain-alternatives.sh <version> <priority>
#
# Example:
#   update-llvm-toolchain-alternatives.sh 19 10
#
# This will register the LLVM 19 toolchain with a priority of 10.

function update_llvm_toolchain_alternatives {
  local version=$1
  local priority=$2
...
update_llvm_toolchain_alternatives $1 $2
