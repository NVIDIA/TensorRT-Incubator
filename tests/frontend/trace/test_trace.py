...
class TestTrace:
    ...
    def test_str(self):
        ...
        assert (
            ...
            == dedent(
                """
                a = storage(data=[0], shape=(1,), dtype=int32, device=cpu:0)
    ...
    def test_multiple_outputs(self):
        ...
        assert (
            ...
            == dedent(
                """
                a = storage(data=[1.0], shape=(1,), dtype=float32, device=cpu:0)
                b = storage(data=[1.0], shape=(1,), dtype=float32, device=cpu:0)
                c = a + b
                d = c + c
                outputs:
