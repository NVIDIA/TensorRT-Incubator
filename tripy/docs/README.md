...
The `dtype_info.dtype_info()` decorator verifies the dtypes of a function and generates 
documentation showing which dtypes are valid and verified. To learn more about how to 
use this decorator check out: `tests/spec_verification/op_doc_guide.md`.
