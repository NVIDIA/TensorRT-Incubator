...
# TODO (pranavm): Better name for this? And maybe move to different file.
class BaseTensor:
...
class Tensor(BaseTensor, metaclass=TensorMeta):
    """
    ...
    def __init__(
        ...
        name = name if name is not None else BaseTensor._get_unique_name()
