...
from sequential.input_features_preprocessors import LearnablePositionalEmbeddingRatedInputFeaturesPreprocessor
from sequential.tripy_input_features_preprocessors.tripy_learnable_positional_embedding_rated_input_features_preprocessor import TripyLearnablePositionalEmbeddingRatedInputFeaturesPreprocessor
...
def test_learnable_positional_embedding_rated_equivalence():
    B, N, D, R = 2, 5, 4, 3
    torch_mod = LearnablePositionalEmbeddingRatedInputFeaturesPreprocessor(N, D, 0.0, R, 5)
    tripy_mod = TripyLearnablePositionalEmbeddingRatedInputFeaturesPreprocessor(N, D, 0.0, R, 5)
    # Copy weights
