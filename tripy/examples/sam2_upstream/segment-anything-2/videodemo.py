...
# pip install -e ".[demo]"
# pip3 install --force-reinstall /tripy/trt102/mlir-tensorrt-compiler-wheel/mlir_tensorrt_compiler-0.1.36+cuda12.trt102-cp310-cp310-linux_x86_64.whl
# pip3 install --force-reinstall /tripy/trt102/mlir-tensorrt-runtime-wheel/mlir_tensorrt_runtime-0.1.36+cuda12.trt102-cp310-cp310-linux_x86_64.whl
# pip3 install nvtx
