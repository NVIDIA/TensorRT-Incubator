...
class TestCache:
    def test_basic_get(self, cache):
        """Test the get method of the cache."""
        key = "test_key"
        value = "test_value"
        ...
        assert cached_value == value, f"Expected {value}, got {cached_value}"

    def test_basic_set(self, cache):
        """Test the set method of the cache."""
        key = "test_key"
        value = "test_value"
    ...
    def test_cache_size(self, cache):
        ...
        assert cache.size() == 2, f"Expected 2 items in the cache, got {cache.size()}"
    ...
    def test_normalize_key(self, cache):
        ...
        print(cache._normalize_key(raw_key))
