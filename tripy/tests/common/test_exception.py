...
from tripy.frontend.utils import convert_inputs_to_shapes
...
class TestRaiseError:
    ...
    def test_convert_inputs_to_shapes_is_excluded(self):
        filename, start_line, end_line = _get_function_file_and_lines(convert_inputs_to_shapes)
        tensor = tp.ones((2, 3))
        ...
        expected = dedent(
            r"""
                ...
                --> [a-z_/\.]+:[0-9]+ in test_convert_inputs_to_shapes_is_excluded\(\)
                    |
