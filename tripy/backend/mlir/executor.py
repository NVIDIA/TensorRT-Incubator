...
class FlatIRExecutor:
    ...
    def __init__(self, executable: void_ptr, output_devices: List) -> None:
        """
        Args:
            executable: mlir executable generated by the compiler
            output_devices: output devices inferred by FlatIR
        """
    ...
    def execute(self, inputs: List[Tensor] = []) -> List[Storage]:
        ...
        exec_args = self.compiler.exec_initializer(self.executable, device_inputs, self.output_devices)
