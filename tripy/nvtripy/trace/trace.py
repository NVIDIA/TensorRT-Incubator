                            ...
                            for output_type, mlir_output_op in zip(output_types, mlir_output_ops):
                                ...
                                mlir_output_op.owner.attributes["metadata"] = ir.StringAttr.get(
                                    ...
                                    + ", ".join(
                                        (
                                            str_from_stack_info(
                                                # Exclude Tripy frames (except the API call plus transitive API calls for composite ops)
                                                # from metadata since they're not useful to the user:
                                                # TODO (pranavm): Figure out how much stack info to include:
