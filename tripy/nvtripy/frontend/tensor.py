...
class Tensor(metaclass=TensorMeta):
    ...
    def eval(self) -> "nvtripy.Tensor":
        """
        Evaluates the tensor, making the tensor to be a constant.
        ...
        out_tensor = executable(*[inp.frontend_tensor for inp in inputs])
        data = out_tensor.trace_tensor.producer.data
